...
export function NavBar({
  ...
  const verticalNavBarClassNames = `relative z-20 ${isOpen ? 'block' : 'hidden'
    } lg:hidden vertical`;
  ...
  const listClassNames = `list-reset ${vertical ? 'absolute w-full left-0' : 'flex flex-1 items-center justify-end'
    }`;
